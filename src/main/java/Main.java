...
public final class Main {
    ...
    public static void main(String... args) throws Exception {
        String inputFile = "/Users/jg067071/Downloads/PR_Data-1.txt";
    ...
    public static void iterate(String input, String output) throws Exception {
        ...
        new Output()
                .setPath(lastPath +FileSystems.getDefault().getSeparator()+"part-r-00000")
                .setInLinks(util.getInLinks())
                .setOutLinks(util.getOutLinks())
                .setOutputDir(output)
                .sort()
                .filter(500) //no of rows needed in output file
                .generateOutput();
    }
